...
public static partial class Tasks
{
    ...
    {
        var query1 = Emps.Select(x => new { x.Ename, x.Job, x.HireDate });
        var query2 = new[] { new { Ename = "Brak wartości", Job = (string)null, HireDate = (DateTime?)null } };
    ...
    public static IEnumerable<Dept> Task14()
    {
        ...
        return Depts.Where(d => empCounts.Any(ec => ec.Deptno == d.Deptno && ec.Count == 5) ||
                                !empCounts.Any(ec => ec.Deptno == d.Deptno))
            .OrderBy(d => d.Dname);
    }
}